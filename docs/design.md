...
- internal/update checks public GitHub release metadata and performs user-confirmed, checksum-verified platform updates; it does not participate in accounting.

...
- internal/update checks public GitHub release metadata and performs user-confirmed, checksum-verified platform updates; GitHub Artifact Attestations provide an additional release-time provenance check. It does not participate in accounting.
